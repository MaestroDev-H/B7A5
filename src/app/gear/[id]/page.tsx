...
export default function GearDetailsPage() {
  ...
  const rawImg = selectedImage || gear?.images?.[0];
  const fallbackDetailImage = "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=800&q=80";
  const mainImage = rawImg && !rawImg.includes("placehold.co") ? rawImg : fallbackDetailImage;
